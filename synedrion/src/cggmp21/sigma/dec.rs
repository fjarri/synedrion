...
impl<P: SchemeParams> DecProof<P> {
    ...
    pub fn new(
        ...
        let nu = SecretSigned::random_bounded_bits_scaled(rng, P::L_BOUND + P::EPS_BOUND, hat_cap_n);
...
mod tests {
    ...
    fn prove_and_verify() {
        ...
        let y = SecretSigned::random_bounded_bits(&mut OsRng, Paillier::PRIME_BITS * 2 - 2);
